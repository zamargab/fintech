...
class EagleDetails extends StatefulWidget {
  EagleDetails({Key key}) : super(key: key);

  @override
  _EagleDetailsState createState() => _EagleDetailsState();
}

class _EagleDetailsState extends State<EagleDetails> {
